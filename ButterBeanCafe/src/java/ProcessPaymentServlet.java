...
public class ProcessPaymentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            //need to gather the customer info from cookie object
            
            Cookie[] c = request.getCookies();
            
            // the list of order made by this customer
            
            //calculate and prepare the page for the customer to make payment
...
//          display all the cookie objects - name & value in table format
